/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1de8211bc90980b1c8a1f42d7e521033)
// Runtime types generated with workerd@1.20260828.1 2026-08-28 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	KUBERNETES_AGENT_READ_GROUP: "kube-cluster-hub:agents:read";
	KUBERNETES_AGENT_WRITE_GROUP: "kube-cluster-hub:agents:write";
	PORT: string;
	HUB_DATABASE_DSN: string;
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./control-plane/entry-worker");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "KUBERNETES_AGENT_READ_GROUP" | "KUBERNETES_AGENT_WRITE_GROUP" | "PORT" | "HUB_DATABASE_DSN" | "HUB_PUBLIC_URL" | "HUB_UI_CLIENT_ID" | "HUB_INVENTORY_ACCESS_URL" | "OIDC_ISSUER" | "KUBERNETES_OIDC_AUDIENCE" | "OIDC_GROUPS_CLAIM" | "CATALOG_ADMIN_GROUPS" | "RESOURCE_SERVER_URL" | "RESOURCE_SERVER_ISSUER" | "RESOURCE_SERVER_AUTHORIZED_CLIENT_IDS" | "RESOURCE_SERVER_JWT_ALGORITHMS" | "DISPATCH_ISSUER" | "DISPATCH_AUDIENCE" | "DISPATCH_SIGNING_PRIVATE_JWK" | "CONNECTOR_STATUS_TOKEN" | "INVENTORY_CLUSTER_ID" | "AUDIT_RETENTION">> {}
}
