...
func LoadConfig() (Config, error) {
	cfg := Config{
		...
		DispatchAudience:        env("DISPATCH_AUDIENCE", "kube-cluster-connector"),
		AgentReadGroup:          env("KUBERNETES_AGENT_READ_GROUP", "kube-cluster-hub:agents:read"),
		AgentWriteGroup:         env("KUBERNETES_AGENT_WRITE_GROUP", "kube-cluster-hub:agents:write"),
